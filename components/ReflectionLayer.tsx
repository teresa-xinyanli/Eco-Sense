...
const ReflectionLayer: React.FC<ReflectionLayerProps> = ({ text }) => {
  return (
    <div className="bg-[#1a1a1a] rounded-t-3xl p-12 text-center relative overflow-hidden mt-8">
       ...
       {/* Main Text */}
       <p className="serif text-2xl md:text-3xl text-white/90 max-w-4xl mx-auto leading-relaxed animate-fade-in">
          "{text}"
       </p>
